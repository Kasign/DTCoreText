...
NSString * const DTUnderLineAttribute = @"DTUnderLine";
NSString * const DTUnderLineTypeAttribute = @"DTUnderLineType";
NSString * const DTBackgroundColorAttribute = @"DTBackgroundColor";
NSString * const DTDecorationThickNessAttribute = @"DTDecorationThickNess";
