...
- (DTColor *)underlineColor
{
    CGColorRef cgColor = (__bridge CGColorRef)[self objectForKey:kCTUnderlineColorAttributeName];
    ...
    if (DTCoreTextModernAttributesPossible())
    {
        DTColor *color = [self objectForKey:NSUnderlineColorAttributeName];
...
- (NSUnderlineStyle)underLineStyle {
    ...
    NSNumber *underLineStyle = [self objectForKey:NSUnderlineStyleAttributeName];
    if (!underLineStyle) {
        underLineStyle = [self objectForKey:(id)kCTUnderlineStyleAttributeName];
    }
    return [underLineStyle integerValue];
}

- (CGFloat)decorationThickNess {
    
    NSNumber *decorationThickNess = [self objectForKey:DTDecorationThickNessAttribute];
    return [decorationThickNess floatValue];
}
